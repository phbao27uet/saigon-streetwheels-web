...
const ERROR_MESSAGES = {
  INVALID_CREDENTIALS: "Thông tin đăng nhập không chính xác. Vui lòng kiểm tra lại!",
...
export const LoginForm: React.FC = () => {
  ...
  const onSubmit = form.handleSubmit(async (value: LoginInputType, event: React.BaseSyntheticEvent | undefined) => {
    try {
